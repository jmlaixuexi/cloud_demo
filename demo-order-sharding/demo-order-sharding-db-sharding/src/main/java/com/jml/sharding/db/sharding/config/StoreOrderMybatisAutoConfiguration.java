package com.jml.sharding.db.sharding.config;

import com.alibaba.druid.spring.boot.autoconfigure.DruidDataSourceBuilder;
import com.google.common.collect.Lists;
import com.jml.sharding.db.sharding.config.algorithm.OrderDbComplexKeysShardingAlgorithm;
import com.jml.sharding.db.sharding.config.algorithm.OrderTbComplexKeysShardingAlgorithm;
...
@MapperScan(sqlSessionFactoryRef = "sqlSessionFactoryStoreOrder", basePackages = {"com.jml.sharding.db.sharding.mapper.storeorder"})
@Configuration
