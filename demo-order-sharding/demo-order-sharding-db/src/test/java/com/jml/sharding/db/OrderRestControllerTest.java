...
@SpringBootTest(classes = {ShardingDbApplication.class})
@AutoConfigureMockMvc
public class OrderRestControllerTest {

    private Logger log= LoggerFactory.getLogger(OrderRestControllerTest.class);
...
//        //构建请求
//        MockHttpServletRequestBuilder request= MockMvcRequestBuilders.get("/order/list")
...
//        MockHttpServletResponse response=mvcResult.getResponse();
        MvcResult mvcResult=mockMvc.perform(MockMvcRequestBuilders.get("/order/list?buyerId=1")).
